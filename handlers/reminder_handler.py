...
async def remind_daily(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    reminder_id = add_reminder(chat_id, None, "daily", text, time_str)
...
async def remind_weekly(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    reminder_id = add_reminder(chat_id, None, "weekly", text, time_str, days_str)
    get_scheduler().add_job(
        send_reminder, 'cron',
...
async def remind_biweekly(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    reminder_id = add_reminder(chat_id, None, "biweekly", text, time_str, days_str)
    get_scheduler().add_job(
        send_reminder, 'cron',
...
async def remind_monthly(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    reminder_id = add_reminder(chat_id, None, "monthly", text, time_str, day_of_month=int(day))
    get_scheduler().add_job(
        send_reminder, 'cron',

...
BROADCAST_GROUPS = [
    {"id": -1002892663170, "name": "총회-도마 위아원", "topic_id": 6},
    {"id": -1002428955065, "name": "총회-다대오 위아원", "topic_id": 6},
    {"id": -1002818420703, "name": "총회-바돌 위아원", "topic_id": 6},
    {"id": -1002585429019, "name": "총회-안드레 위아원", "topic_id": 6},
    {"id": -1002794725000, "name": "총회-요한 위아원", "topic_id": 4},
    {"id": -1002799842466, "name": "총회-시몬 위아원", "topic_id": 6},
    {"id": -1002783667426, "name": "총회-맛디아 위아원", "topic_id": 6},
    {"id": -1002570051988, "name": "총회-서야 위아원", "topic_id": 6},
    {"id": -1002706540911, "name": "총회-빌립 위아원", "topic_id": 6},
    {"id": -1002875297688, "name": "총회-부야 위아원", "topic_id": 8},
    {"id": -1002521687145, "name": "총회-베드로 위아원", "topic_id": 6},
    {"id": -1002510343383, "name": "총회-마태위아원", "topic_id": 6},
    {"id": -1002762822230, "name": "12지파교통부장", "topic_id": 2},
]
...
async def handle_all_messages(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    print(f"그룹 ID: {chat_id} | 토픽 ID: {update.message.message_thread_id} | 그룹명: {update.message.chat.title} | 메시지: {text}")
